		...
		<div class="row tm-main-row">
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
					...
					<section id="tm-section-1" class="tm-section">
						...
						<header class="mb-4"><h1 class="tm-text-shadow">Bienvenido/a {{ Auth::user()->name }}
							...
							@else
							<header class="mb-4"><h1 class="tm-text-shadow">Bienvenido PROVEEDOR</h1></header>
							@endauth
							@endif
                ...
                <div class="top-right links">
                    @auth
                        <a href="#" class="btn tm-btn tm-font-big" data-nav-link="#tmNavLink2">Sesión Iniciada</a>
            ...
            @endif
					...
					<section id="tm-section-2" class="tm-section tm-section-carousel">
						<div>
							<header class="mb-4"><h2 class="tm-text-shadow">Transporte</h2></header>		            
								  <div class="row">
					...
					<section id="tm-section-3" class="tm-section tm-section-carousel">
						<div class="row mb-4">
							<header class="mb-4"><h2 class="tm-text-shadow">Alojamientos</h2></header>	
							</div>	            
								  <div class="row">
