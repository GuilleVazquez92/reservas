...
<h1 align="center" id="RegistrarAlojamiento">Editar Alojamiento</h1>
<form action="{{route('AlojaEditar')}}" method="POST">
  {{csrf_field()}}
 ...
 @if (!(empty($aloja)))
 <div class="form-row">
    <input type="hidden" value="{{$aloja->id}}" name="id">
   <div class="form-group col-md-5">
    <label for="inputEmail4">Nombre del Alojamiento</label>
    <input type="text" class="form-control" name="nombre" placeholder="Nombre" value="{{$aloja->nombre}}">
  ...
  <input type="text" class="form-control" name="referencia" placeholder="" value="{{$aloja->referencia}}">
...
<div class="form-row">
 ...
 <div class="form-group col-md-6">
  ...
  <input type="text" class="form-control" name="direccion" placeholder="" value="{{$aloja->direccion}}">
...
<div class="form-row">
 ...
 <div class="form-group col-md-4">
  ...
  <input type="email" class="form-control" name="correo" placeholder="Correo" value="{{$aloja->email}}">
   @if ($errors->has('correo'))
        <small class="form-text text-danger">{{ $errors->first('correo') }}</sm all>
     @endif
</div>
...
<div class="form-row">
 <div class="form-group col-md-10">
  ...
  <input type="text" class="form-control" name="descripcion" placeholder="" value="{{$aloja->descripcion}}">
</div>
